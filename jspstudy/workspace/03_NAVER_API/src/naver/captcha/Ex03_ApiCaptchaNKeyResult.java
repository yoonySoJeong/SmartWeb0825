...
public class Ex03_ApiCaptchaNKeyResult {
	...
	public static void main(String[] args) {
		...
		String value = "7Y2E";		// 그림문자.		// login의 입력받는 변수와 통일
		...
		try {
			...
			if (responseCode == HttpURLConnection.HTTP_OK) { 				// 200이라고 써도 무방 : 성공  // else --> 실패의 경우
				...
				boolean result = (boolean) obj.get("result");	// Object 이기 때문에 String으로 Casting 해야 한다.
				System.out.println(result);		// boolean이므로 true/false 
			} else {	
