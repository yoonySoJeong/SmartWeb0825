...
<head>
	...
	<script>
		$(document).ready(function(){
			...
			$('#kor').on('keyup blur', fnKorCheck);			// callback 전달.
		...
		<form id="f" action="/BATCH/insertStudent.do" method="post">
			<table>
				...
				<tfoot>
					<tr>
						<td colspan="5">
							<input type="submit" value="학생등록하기" id="insert_btn">	<!-- input에 submit 적으면 그것도 걍 submit버튼이므로 이런식으로 CSS적용이 쉽도록 tag설정하는 것이 가능 함. -->
